...
> Citizen service portal with multilingual translation templates. Integrates WhatsApp Business API and Telegram channels for grievance routing.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/civic-sight/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-civic-sight.git
cd tp-civic-sight
```
...
```bash
kubectl port-forward deployment/tp-civic-sight 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── whatsapp_grievance.json     # Main configuration file
```
...
---
*Generated by [Civic Sight Studio](https://pradeeptalari14.github.io/portfolio/tools/civic-sight/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
